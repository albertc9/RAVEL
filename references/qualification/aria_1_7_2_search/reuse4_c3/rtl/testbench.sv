...
reuse4_c3 dut(.ap_clk(clk), .ap_rst_n(rst), .ap_start(start), .ap_ready(control_ready),
 .calibration_input_TDATA(in_data), .calibration_input_TVALID(in_valid), .calibration_input_TREADY(in_ready),
