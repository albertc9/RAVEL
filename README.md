...
The performance figures below describe the historical single-convolution
reference model; they are not throughput promises for other architectures.
...
## Single-convolution reference performance
