...
RAVEL v1.2.3 delivers a 17.3x lower initiation interval and 16.9x lower cycle latency,
with 86.7% fewer FF, 24.6% fewer LUT, and no BRAM_18K. The estimated clock periods are 3.619 ns for vanilla hls4ml and 3.647 ns for RAVEL. Resource figures in this table are Vitis
