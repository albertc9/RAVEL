...
With 16 time-interleaved cores, the model family has an estimated processing
capacity of approximately 20 GSa/s per channel for an 8-channel ADC stream on
the KU5P.
...
| Flow | II | Latency (cycles) | BRAM tile | DSP | registers | LUTs | Fmax (MHz) | WNS (ns) |
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| Vanilla hls4ml | 3076 | 3084 | 5.5 (1.15%) | 1 (0.05%) | 21745 (5.01%) | 18312 (8.44%) | 208.6 | +0.206 |
| RAVEL Aria 1.1.0 P2/D1 | 178 | 183 | 1.0 (0.21%) | 7 (0.38%) | 2953 (0.68%) | 5332 (2.46%) | 257.8 | +1.121 |
| RAVEL Aria 1.3.0 P4/D2 | 94 | 99 | 0.5 (0.10%) | 14 (0.77%) | 3709 (0.85%) | 7861 (3.62%) | 239.1 | +0.817 |
| RAVEL Aria 1.4.0 P4/D2 | 94 | 99 | 1.5 (0.31%) | 15 (0.82%) | 3622 (0.83%) | 6981 (3.22%) | 223.4 | +0.524 |
| RAVEL Aria 1.6.0 PHARA P8/D4 | 51 | 56 | 2.5 (0.52%) | 79 (4.33%) | 3840 (0.88%) | 4930 (2.27%) | 249.8 | +0.997 |
...
PHARA processes 1.004 GSa/s per core. Relative to Aria 1.4, it reduces II by
...
At the timing-estimated 249.8 MHz, one PHARA core processes 1.254 GSa/s. A
16-core estimate reaches 20.1 GSa/s and uses 36.4% of LUTs, 14.2% of registers,
69.3% of DSPs, and 8.3% of BRAM tiles. DSP is the replication limit: applying a
70% LUT budget alone would exceed the available DSP count. This estimate assumes
linear core scaling and excludes system interconnect, I/O, and multi-core
routing overhead.
