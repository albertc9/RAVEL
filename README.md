...
| Flow | II | Latency (cycles) | HLS clock (ns) | BRAM tile | DSP | registers | LUTs | WNS (ns) |
|---|---:|---:|---:|---:|---:|---:|---:|---:|
...
| RAVEL Aria 1.6.0 PHARA P8/D4 | 51 | 56 | 4.289 | 2.5 (0.52%) | 79 (4.33%) | 3840 (0.88%) | 4930 (2.27%) | +0.997 |
