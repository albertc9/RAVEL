...
Resource entries are shown as count (percentage of KU5P capacity).

| Flow | II | Latency (cycles) | Est. clock (ns) | BRAM_18K | DSP | FF | LUT |
|---|---:|---:|---:|---:|---:|---:|---:|
| Vanilla hls4ml | 3076 | 3084 | 3.619 | 18 (1.88%) | 0 (0.00%) | 26275 (6.06%) | 38365 (17.68%) |
| RAVEL Aria 1.1.0 P2/D1 | 178 | 183 | 3.647 | 0 (0.00%) | 4 (0.22%) | 3483 (0.80%) | 28922 (13.33%) |
| RAVEL Aria 1.3.0 P4/D2 | 94 | 99 | 3.502 | 0 (0.00%) | 8 (0.44%) | 4436 (1.02%) | 53502 (24.66%) |
| RAVEL Aria 1.4.0 P4/D2 | 94 | 99 | 3.402 | 3 (0.31%) | 8 (0.44%) | 4368 (1.01%) | 15623 (7.20%) |

Aria 1.4 retains the Aria 1.3 II and latency while reducing estimated LUT by
70.8% and FF by 1.5%. Its packed Dense weight ROM uses three BRAM_18Ks; DSP
usage remains eight. Resource figures are Vitis HLS estimates. See the
[Aria 1.4 synthesis and RTL CoSim evidence](references/cnn_for_arianna/reports/aria_1_4_p4d2.json)
